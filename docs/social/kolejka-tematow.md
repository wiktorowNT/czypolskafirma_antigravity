...
- [ ] Kto jest właścicielem Żabki (6 863 wyświetlenia profilu, CTR 0,29%). **Wstrzymane**: przejęcie Żabki przez Couche-Tard opisywało dziewięć paczek z sierpnia 2026, więc wpis o właścicielu byłby tą samą historią w innym ujęciu. Wrócić, gdy transakcja się domknie i będzie można opisać stan po niej
